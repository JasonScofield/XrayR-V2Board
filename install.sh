...
install_XrayR() {
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/JasonScofield/XrayR-V2Board/master/XrayR.sh
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/JasonScofield/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
